...
from Converter import convert_ttranf_phases, convert_tfascon_bus, convert_tten, convert_ttranf_windings, \
    convert_tfascon_conn, convert_tpotaprt, convert_tfascon_phases, convert_tfascon_bus_prim, convert_tfascon_bus_sec, \
    convert_tfascon_bus_terc, convert_tfascon_phases_trafo
from Tools.Utils import create_output_file
...
class Transformer:
    ...
    def pattern_MRT(self):
        ...
        return (
            f'New "Linecode.LC_MRT_TRF_{self.transformer}_1" nphases=1 basefreq=60 r1=15000 x1=0 units=km normamps=0\n'
    ...
    def create_transformer_from_json(json_data: Any, dataframe: gpd.geodataframe.GeoDataFrame):
        ...
        progress_bar = tqdm(dataframe.iterrows(), total=len(dataframe), desc="Transformer", unit=" transformers",
                            ncols=100)
